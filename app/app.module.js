...
AppModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [app_component_1.AppComponent, table_component_1.TableComponent, empty_date_pipe_1.EmptyDatePipe, date_from_number_pipe_1.DurationPipe, modal_component_1.ModalComponent, modal_time_component_1.ModalTimeComponent, modal_admin_component_1.ModalAdminComponent],
        providers: [user_service_1.UserService, time_log_service_1.TimeLogService, project_service_1.ProjectService, activity_service_1.ActivityService, pager_service_1.PagerService],
